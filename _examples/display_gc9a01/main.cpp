...
{
    dm.registerDisplay(new DisplayGc9a01);
}
} //namespace mxgui
...
int main()
{
    auto& display=DisplayManager::instance().getDisplay();
    {
        ...
        dc.setFont(droid21);
        dc.write(Point(50,50),"Miosix OS");
        dc.setFont(tahoma);
        dc.write(Point(50,50+droid21.getHeight()),"MXGUI graphics library");
    }
    for(int i=0;;i++)
    {
        {
            ...
            dc.write(Point(50,50+droid21.getHeight()+tahoma.getHeight()),s);
        }
        Thread::sleep(1000);
    }
}
