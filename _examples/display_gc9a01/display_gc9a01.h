...
#error The QMI8658 driver requires a color depth of 16bit per pixel
#endif

class DisplayGc9a01 : public Display
{
public:
    /**
     * Constructor.
    ...
    public:
        ...
        {
            pixelLeft--;
            DisplayGc9a01::doWritePixel(color);
            if(pixelLeft==0) DisplayGc9a01::doEndPixelWrite();
            return *this;
        }
    ...
    private:
        ...
        friend class DisplayGc9a01; //Needs access to ctor
    };
...
private:
    ...
    static constexpr unsigned char MADCTL_MY = 0x80;  ///< Bottom to top
    static constexpr unsigned char MADCTL_MX = 0x40;  ///< Right to left
    static constexpr unsigned char MADCTL_MV = 0x20;  ///< Reverse Mode
    static constexpr unsigned char MADCTL_ML = 0x10;  ///< LCD refresh Bottom to top
    static constexpr unsigned char MADCTL_RGB = 0x00; ///< Red-Green-Blue pixel order
    static constexpr unsigned char MADCTL_BGR = 0x08; ///< Blue-Green-Red pixel order
    static constexpr unsigned char MADCTL_MH = 0x04;  ///< LCD refresh right to left
