...
public:
    ...
    static constexpr RGB565Color mix(RGB565Color c1, RGB565Color c2, unsigned char scale)
    {
        ...
        unsigned short r = ( (static_cast<unsigned short>(c1.color >> 11) * (256 - s)) +
                             (static_cast<unsigned short>(c2.color >> 11) * s) ) >> 8;

        unsigned short g = ( (static_cast<unsigned short>((c1.color & 0x07E0) >> 5) * (256 - s)) +
                             (static_cast<unsigned short>((c2.color & 0x07E0) >> 5) * s) ) >> 8;

        unsigned short b = ( (static_cast<unsigned short>(c1.color & 0x001F) * (256 - s)) +
                             (static_cast<unsigned short>(c2.color & 0x001F) * s) ) >> 8;
...
public:
    ...
    {
        unsigned short s = scale;
        unsigned short val = ( static_cast<unsigned short>(c1.color) * (256 - s) + static_cast<unsigned short>(c2.color) * s ) >> 8;
        return fromRaw( static_cast<unsigned char>(val & 0x0F) );
    }
...
public:
    ...
    static constexpr RGB332Color mix(RGB332Color c1, RGB332Color c2, unsigned char scale)
    {
        ...
        unsigned short r = ( (static_cast<unsigned short>(c1.color & 0xE0) * (256 - s)) + (static_cast<unsigned short>(c2.color & 0xE0) * s) ) >> 8;
        unsigned short g = ( (static_cast<unsigned short>(c1.color & 0x1C) * (256 - s)) + (static_cast<unsigned short>(c2.color & 0x1C) * s) ) >> 8;
        unsigned short b = ( (static_cast<unsigned short>(c1.color & 0x03) * (256 - s)) + (static_cast<unsigned short>(c2.color & 0x03) * s) ) >> 8;
...
public:
    ...
    static constexpr RGB888Color mix(RGB888Color c1, RGB888Color c2, unsigned char scale)
    {
        ...
        unsigned short s = scale, inv = 256 - s;
        unsigned char r = (((v1 >> 16) & 0xFF) * inv + ((v2 >> 16) & 0xFF) * s) >> 8;
        unsigned char g = (((v1 >>  8) & 0xFF) * inv + ((v2 >>  8) & 0xFF) * s) >> 8;
        unsigned char b = (( v1        & 0xFF) * inv + ( v2        & 0xFF) * s) >> 8;
